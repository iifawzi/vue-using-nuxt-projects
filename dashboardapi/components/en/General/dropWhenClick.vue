  ...
  <div class="en-dropWhenClick">
    <div class="en-dropWhenClick-content" @click="toggleDropped">
      <div class="en-dropWhenClick-content-toClickOn">
        <div class="en-dropWhenClick-content-toClickOn-string">{{dropLabel}}</div>
        <div v-if="!noArrow" class="en-dropWhenClick-toClickOn-content-arrow">
        <i :class="isDropped ? 'fas fa-angle-up' : 'fas fa-angle-down'"></i>

        </div>
      </div>
      <div v-if="isDropped" class="en-dropWhenClick-content-toShowOn" :style="marginSet">
<slot/>
      </div>
    </div>
  </div>
