  ...
  <div class="en-dealInfo">
    <div class="en-dealInfo-content">
      ...
      <div class="en-dealInfo-content-images">
        <div class="en-dealInfo-content-images-mainShow">
          ...
          <div
            ...
            v-if="imageIndex == 1"
            style="background-image: url('https://source.unsplash.com/random?sig=239310')"
          >
            <div v-show="options" class="en-dealInfo-content-images-mainShow-image-options">
              <div
        ...
        <div class="en-dealInfo-content-images-thumb">
          <div :class="{activeThumb: imageIndex==1}" class="en-dealInfo-content-images-thumb-image">
            <img
              src="https://source.unsplash.com/random?sig=239310"
              class="en-dealInfo-content-images-thumb-image-img"
            />
          </div>
          <div :class="{activeThumb: imageIndex==2}" class="en-dealInfo-content-images-thumb-image">
            <img
              src="https://source.unsplash.com/random?sig=25210"
              class="en-dealInfo-content-images-thumb-image-img"
            />
          </div>
          <div :class="{activeThumb: imageIndex==3}" class="en-dealInfo-content-images-thumb-image">
            <img
              src="https://source.unsplash.com/random?sig=29"
              class="en-dealInfo-content-images-thumb-image-img"
            />
          </div>
          <div :class="{activeThumb: imageIndex==4}" class="en-dealInfo-content-images-thumb-image">
            <img
              src="https://source.unsplash.com/random?sig=23210"
              class="en-dealInfo-content-images-thumb-image-img"
            />
          </div>
          <div :class="{activeThumb: imageIndex==5}" class="en-dealInfo-content-images-thumb-image">
            <img
      ...
      <div class="en-dealInfo-content-highlights">
        ...
        <div class="en-dealInfo-content-highlights-highlight">
            Workout website featured on GMA and TODAY has more than 800 yoga, cardio, and strength-training workouts to help users get fit at home
        </div>
      </div>
       <div class="en-dealInfo-content-reviews">
        ...
        <div class="en-dealInfo-content-reviews-rate">
            <div class="en-dealInfo-content-reviews-rate-number">4.3</div>
    ...
    <i class="fas fa-star colored-star"></i>
        ...
        <div class="en-dealInfo-content-reviews-relevent">
            <!-- comments -->
            <div class="en-dealInfo-content-reviews-relevent-item">
                <div class="en-dealInfo-content-reviews-relevent-item-header">
                    <div class="en-dealInfo-content-reviews-relevent-item-header-img">
                        L
                    </div>
                     <div class="en-dealInfo-content-reviews-relevent-item-header-name">
                        <span class="en-dealInfo-content-reviews-relevent-item-header-name-user">
                            Latile
                            </span> 
                           <div class="en-dealInfo-content-reviews-relevent-item-header-name-stars">
                                <i class="fas fa-star colored-star en-dealInfo-content-reviews-relevent-item-header-name-star"></i>
                          <i class="fas fa-star colored-star en-dealInfo-content-reviews-relevent-item-header-name-star"></i>
                           <span class="en-dealInfo-content-reviews-relevent-item-header-name-number">
                                   230 review
                               </span>
                               </div> 
                 ...
                 I have really enjoyed the variety of workouts at Daily Burn. It's not perfect but it's been good for me to reintroduce consistency in exercise. I need the structure of following a program without having to make decisions about what workout I should do next. I'm only a month into a free trial but I can see sticking with this as all I have to do is roll out.
                </div>
            </div>
...
Attend streaming sessions and watch recorded workouts
Over 2,000 workout video types, including:
Group workouts
1-on-1 training
Yoga
Barre
Muscle Building
Pilates
Available on any connected device, including iOS, Android, Apple TV, Roku, Chromecast, and Amazon Fire
Gain access to an online community to chat directly with trainers and other Daily Burn members
All workouts are downloadable.
            </div>
      </div>
